    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 px-4 sm:px-6 py-8 max-w-6xl mx-auto w-full -mt-4">
        ...
        <div className="flex flex-wrap gap-3 mb-6">
          <Button
            data-ocid="student.voicelab.button"
            variant="outline"
        ...
        {showVoiceLab && (
          <VoiceLab
            ...
            currentDisplayName={student.name}
            currentRole="student"
            classes={myClasses}
          />
        )}
          ...
          <>
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground leading-relaxed">
                        Your parent needs this code when linking their account
                        to view your progress, grades, and upcoming sessions.
                      </p>
                    </div>
                    <div
            ...
            <section className="mb-8">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Find an assignment set by your teacher, select it, and book a
                video call to discuss it and receive your grade.
              </p>
              ...
              {assignments.length === 0 ? (
                ...
                >
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Assignments created by your teacher will appear here. Once
                    one is available, you can book a video call.
                  </p>
                </div>
            ...
            <section className="mb-8">
              ...
              {myGrades.length === 0 ? (
                ...
                >
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Grades will appear here once your teacher marks your work
            ...
            {(() => {
              ...
              return (
                <section
                  className="mb-8"
                  data-ocid="student.my_reports.section"
                >
                  <h2 className="font-display text-xl font-bold text-foreground mb-4 flex items-center gap-2">
            ...
            {(() => {
              ...
              return (
                <section
                  className="mb-8"
                  data-ocid="student.term_holidays.section"
                >
                  <h2 className="font-display text-xl font-bold text-foreground mb-4 flex items-center gap-2">
            ...
            {canReview && (
              <section className="mb-8">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Share your experience to help other students find the right
                  tutor.
                </p>
                {reviewSubmitted ? (
                  <div className="bg-student/10 border border-student/30 rounded-xl p-5 flex items-center gap-3">
                    ...
                    <p className="text-sm font-medium text-student">
                      Thank you! Your review has been submitted and is visible
                      on the home page.
                    </p>
                  </div>
                ) : (
                        ...
                        {[1, 2, 3, 4, 5].map((star) => (
                          ...
                          >
                            <Star
                              ...
                              stroke={
                                star <= reviewRating ? "#f59e0b" : "#d1d5db"
                              }
                            />
                          </button>
                        ))}
